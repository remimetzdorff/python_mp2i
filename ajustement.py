...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 18 15:20:37 2022
TP05 - Ajustement linéaire
...
filename = "scope_0.csv" # nom du fichier contenant les données
                         # le programme et le fichier doivent être dans le même répertoire
...
############################################
start  = -0.0049    # début de la portion utile, en secondes
stop   = -0.0035     # fin de la portion utile, en secondes
